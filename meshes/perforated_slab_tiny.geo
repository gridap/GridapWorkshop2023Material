...
Transfinite Curve {5,19} = 15 Using Progression 1;   // circle
Transfinite Curve {6,9,12,17} = 30 Using Progression 1; // walls
Transfinite Curve {7,10,13,14} = 10 Using Progression 1;   // inlet
Transfinite Curve {8,11,15,16} = 8 Using Progression 1;   // outlet
