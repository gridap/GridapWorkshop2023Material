...
Transfinite Curve {5} = 20 Using Progression 1;   // circle
Transfinite Curve {6,9} = 35 Using Progression 1; // walls
Transfinite Curve {7} = 15 Using Progression 1;   // inlet
Transfinite Curve {8} = 8 Using Progression 1;   // outlet
